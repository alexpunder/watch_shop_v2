    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Цена не может быть ниже 1')], verbose_name='Цена часов')),
