# Generated by Django 4.2 on 2024-05-11 11:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(choices=[('В наличии', 'В наличии'), ('Уточнить у менеджера', 'Уточнить у менеджера')], max_length=255, unique=True, verbose_name='Наличие')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material_alt', models.CharField(help_text='Для лучшего отображения на детальной странице часов. Обязательное поле.', max_length=255, verbose_name='Альтернативное описание материала корпуса')),
                ...
                ('waterproof', models.CharField(blank=True, help_text='Указывать в местрах. Например: "50 м". Необязательное поле.', max_length=255, null=True, verbose_name='Водонепроницаемость')),
                ...
                ('image', models.ImageField(blank=True, default=None, help_text='Необязательное поле, но очень желательное.', null=True, upload_to='watches_images')),
                ...
                ('material', models.ForeignKey(default=1, help_text='Для фильтра на странице со списком часов.', on_delete=django.db.models.deletion.SET_DEFAULT, to='main.material', verbose_name='Материал корпуса')),
